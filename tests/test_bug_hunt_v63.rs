...
fn test_batch_insert_mixed_types() {
    ...
    db.execute("CREATE TABLE t(id INT PRIMARY KEY, s TEXT, v FLOAT)")
        .unwrap();
    db.execute("INSERT INTO t VALUES (1,'a',1.5),(2,'b',2.5),(3,'c',3.5)")
        .unwrap();
...
fn test_insert_with_explicit_columns_reordered() {
    ...
    db.execute("INSERT INTO t (b, id, a) VALUES (20, 1, 10)")
        .unwrap();
...
fn test_insert_partial_columns_multiple() {
    ...
    db.execute("CREATE TABLE t(id INT PRIMARY KEY, a INT, b INT, c INT)")
        .unwrap();
    db.execute("INSERT INTO t (id, a) VALUES (1,10),(2,20)")
        .unwrap();
...
fn test_insert_text_with_special_chars() {
    ...
    db.execute("CREATE TABLE t(id INT PRIMARY KEY, s TEXT)")
        .unwrap();
    db.execute("INSERT INTO t VALUES (1,'with spaces'),(2,'with-dash'),(3,'with.dot')")
        .unwrap();
...
fn test_left_join_aggregate() {
    ...
    db.execute("CREATE TABLE users(id INT PRIMARY KEY, name TEXT)")
        .unwrap();
    db.execute("CREATE TABLE orders(id INT PRIMARY KEY, uid INT, amt INT)")
        .unwrap();
